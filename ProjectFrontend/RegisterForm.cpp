...
void RegisterForm::SubmitReg()
{
	...
	case CharSel::CH_CUSTOMER:
		...
		MainLogic::s_currentCustomers.insert(std::make_pair(pSignup->GetId(), *dynamic_cast<Customer*>(pSignup)));
		break;
	case CharSel::CH_COOK:
		...
		MainLogic::s_currentCooks.insert(std::make_pair(pSignup->GetId(), *dynamic_cast<Cook*>(pSignup)));
		break;
	case CharSel::CH_WAITOR:
		...
		MainLogic::s_currentWaitors.insert(std::make_pair(pSignup->GetId(), *dynamic_cast<Waitor*>(pSignup)));
		break;
	case CharSel::CH_MANAGER:
		...
		MainLogic::s_currentManagers.insert(std::make_pair(pSignup->GetId(), *dynamic_cast<Manager*>(pSignup)));
		break;
	case CharSel::CH_MAINTAINER:
		...
		MainLogic::s_currentMaintainers.insert(std::make_pair(pSignup->GetId(), *dynamic_cast<Maintainer*>(pSignup)));
		break;
	default:
		break;
	}
